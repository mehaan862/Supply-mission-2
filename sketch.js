...
function setup() {
	...
	boxSide2=createSprite(500,610,20,100);
	...
	boxBottom = Bodies.rectangle(400, 650, 200, 20 , {isStatic:false} );
 	World.add(world, boxBottom);
	 
	boxSide1 = Bodies.rectangle(300, 610, 200, 20 , {isStatic:false} );
	 World.add(world, boxSide1);
	 
	 boxSide2 = Bodies.rectangle(500, 610, 200, 20 , {isStatic:false} );
